...
begin
  ...
  SheetRegiste.TabVisible := nIsAdmin;
...
begin
  ...
  else if wPage.ActivePage = SheetRegiste then
    CreateBaseFrameItem(cFI_FrameRegiste, SheetRegiste, alNone).Centered := True
end;
